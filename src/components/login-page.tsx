      ...
      <Card className="w-full max-w-md shadow-2xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex gap-2 justify-center">
            <Badge
              variant={loginTab === "email" ? "default" : "outline"}
            ...
            <Badge
              variant={loginTab === "google" ? "default" : "outline"}
              className="cursor-pointer px-4 py-2"
              onClick={() => {
                setLoginTab("google");
                setError(null);
          ...
          {loginTab === "google" && (
            <div className="space-y-4">
              ...
              <Button
                ...
                disabled={isLoading}
                className="w-full h-12 bg-white text-gray-700 border-2 border-gray-300 hover:bg-gray-50 flex items-center justify-center gap-2"
              >
                <svg
                  width="20"
                  height="20"
